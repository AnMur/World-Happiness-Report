...
This is a group project where I've collaborated with the ***SACV Consulting***. My role was to work on the EDA part and Modeling. There are 4 notebooks (***EDA for Happiness***, ***Extreme Gradient Boosting Only***, ***Four Standard Models*** and ***Light Gradient Boosting Model Only***). While the ***EDA For Happiness*** and ***Four Standard Models*** include very deep research and exploration, 2 other notebooks tend to be more experimental works to see how XGBM and LGBM would solve a problem. The EDA part include many different graphs and plots available from matplotlib and seaborn as well as geoplots from plotly.
